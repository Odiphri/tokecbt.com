...
export const STAFF_ROLES = ["teacher", "hod", "librarian", "custom"] as const;
...
export const teachersTable = pgTable("teachers", {
  ...
  permissions: jsonb("permissions").$type<StaffPermissions>().default({ manage_exams: true, view_all_results: false, manage_students: false }).notNull(),
});
